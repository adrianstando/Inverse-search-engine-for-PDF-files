...
The app uses by default [PorterStemmer](https://tartarus.org/martin/PorterStemmer/) ([read more](http://snowball.tartarus.org/algorithms/porter/stemmer.html)) algorithm for [word stemming](https://en.wikipedia.org/wiki/Stemming). You can disable this option by selecting appropriate box (you have to do it before choosing starting path).
